...
/*	public static void main(String[] args) {
	...
	//	System.out.println("The Total MIPS is " +total_MIPS);
		// System.out.println("The total Requested MIPS is " +totalRequested_MIPS );
		 ...
		 double SLA_Unmet_real = round(((SLA_Unmet*0.01)/44),5); 
		 
		 System.out.println("The SLA Unmet for BFV is " +SLA_Unmet_real + "%");
...
public static double calculateSLAoverloaded(int noofHosts) {
	int maxSlaTime = 2000;
	int minSlaTime = 1000;
	double minSlaViolation = 4.765; // recheck these - modify
	double maxSlaViolation = 6.941; // recheck these - modify
	...
	System.out.println("The SLA overloaded for BFV is " +round(SLA_Overloaded ,3)  +"%");
