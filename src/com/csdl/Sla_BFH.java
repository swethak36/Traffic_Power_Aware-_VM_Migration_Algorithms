...
public class Sla_BFH {
	...
	//	System.out.println("The Total MIPS is " +total_MIPS);
		// System.out.println("The total Requested MIPS is " +totalRequested_MIPS );
		 ...
		 double SLA_Unmet_real = round(((SLA_Unmet*0.01)/22),5); 
		 
		 System.out.println("The SLA Unmet for BFH is " +SLA_Unmet_real + "%");
...
public static double calculateSLAoverloaded(int noofHosts) {
	int maxSlaTime = 2000;
	int minSlaTime = 1000;
	double minSlaViolation = 0.842; // recheck these - modify
	double maxSlaViolation = 0.983; // recheck these - modify
	...
	System.out.println("The SLA overloaded for BFH is " +round(SLA_Overloaded ,3)  +"%");
